...
// Brand mark path/gradient data below is copied from @lobehub/icons-static-svg
// (MIT licensed, https://github.com/lobehub/lobe-icons) — a maintained
// collection of official AI/LLM brand logos. Veo and Higgsfield don't have a
// published mark in that set (or any other icon library) yet, so they use a
// plain monogram badge instead of a guessed/fabricated logo — swap in the
// official SVG for those two once one is published.
...
function GrokIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
function MidjourneyIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
function DalleIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 24 24" {...props}>
...
// No published official mark for these two yet — plain monogram badge
// instead of a guessed logo. Swap for the real SVG once one exists.
function monogram(letter: string, bg: string) {
    return function MonogramIcon(props: React.SVGProps<SVGSVGElement>) {
        return (
            <svg viewBox="0 0 24 24" {...props}>
                <rect width="24" height="24" rx="6" fill={bg} />
                <text x="12" y="16.5" textAnchor="middle" fontSize="12" fontWeight="700" fill="#fff" fontFamily="sans-serif">
                    {letter}
                </text>
            </svg>
        )
...
export type AiModel = {
    ...
    /** PLACEHOLDER — swap for the real deep link when provided. */
    link: string
}

export const AI_MODELS: AiModel[] = [
    { id: "chatgpt", name: "ChatGPT", color: "#10A37F", icon: OpenAIIcon, link: "https://chat.openai.com" },
    { id: "claude", name: "Claude", color: "#D97757", icon: ClaudeIcon, link: "https://claude.ai" },
    { id: "gemini", name: "Gemini", color: "#3186FF", icon: GeminiIcon, link: "https://gemini.google.com" },
    { id: "grok", name: "Grok", color: "#000000", icon: GrokIcon, link: "https://grok.com" },
    { id: "runway", name: "Runway", color: "#000000", icon: RunwayIcon, link: "https://runwayml.com" },
    { id: "veo", name: "Veo", color: "#4285F4", icon: monogram("V", "#4285F4"), link: "https://labs.google/fx/tools/veo" },
    { id: "higgsfield", name: "Higgsfield", color: "#7C3AED", icon: monogram("H", "#7C3AED"), link: "https://higgsfield.ai" },
    { id: "midjourney", name: "Midjourney", color: "#000000", icon: MidjourneyIcon, link: "https://www.midjourney.com" },
    { id: "dalle", name: "DALL-E", color: "#000000", icon: DalleIcon, link: "https://labs.openai.com" },
]
