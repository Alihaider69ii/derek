        ...
        <div className="flex items-center gap-2 mb-6">
            {[1, 2, 3].map((step, i) => (
                <React.Fragment key={step}>
                    <div
                        className={`w-6 h-6 rounded-full flex items-center justify-center text-[0.7rem] font-bold shrink-0 ${step < current
                    ...
                    {i < 2 && (
                        <div className={`flex-1 h-[2px] rounded-full ${step < current ? "bg-accent" : "bg-border"}`} />
                    )}
                </React.Fragment>
            ))}
        </div>
        ...
        <div className="min-h-screen flex flex-col md:grid md:grid-cols-2 bg-bg-base">
            ...
            <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
                <div className="w-full max-w-[420px]">
                    ...
                    <p className="text-sm text-text-secondary mt-1 mb-6">Free to start. No credit card needed.</p>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="relative my-5">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-bg-base text-text-secondary">or use email</span>
                            </div>
                        </div>
